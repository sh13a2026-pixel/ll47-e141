...
# ============================================================
# ===== LOGO B64 (embedded for APK/mobile compatibility)  =====
# ============================================================
_LOGO_B64 = ""
...
# ============================================================
# ===== PHIÊN BẢN ỨNG DỤNG & CẤU HÌNH FORCE UPDATE         =====
# ============================================================
APP_VERSION = "2.6.0"
...
class App:
    ...
    def sidebar_nav(self) -> ft.Container:
        ...
        logo_widget = ft.Image(src_base64=_LOGO_B64, width=72, height=72, fit=ft.ImageFit.COVER)
...
def show_login(page: ft.Page) -> None:
    ...
    logo_src = "logo.png"
    logo_control = ft.Image(src=logo_src, width=190, height=190, fit=ft.ImageFit.COVER)
...
async def _main_inner(page: ft.Page):
    ...
    logo_src = "logo.png"
    logo_widget = ft.Image(src_base64=_LOGO_B64, width=110, height=110, fit=ft.ImageFit.CONTAIN)
    ...
    # Xin quyền hệ điều hành (chạy nền, tuyệt đối không chặn splash)
    ...
    try:
        ...
        if _is_mobile:
            async def _request_permissions_async():
                try:
                    ...
                    pass
            page.run_task(_request_permissions_async)
    except Exception:
        pass

    # ══════════════════════════════════════════════════════════════════
    # BƯỚC 4 — KIỂM TRA BẮT BUỘC CẬP NHẬT (FORCE UPDATE)
    # ══════════════════════════════════════════════════════════════════
    try:
        _splash_status.value = "Đang kiểm tra phiên bản..."
        page.update()

        import urllib.request
        import urllib.error
        import json
        from app.firebase_config import API_BASE_URL

        # timeout=5s để tránh treo cứng app nếu server ko phản hồi
        url = f"{API_BASE_URL}/api/sys/config"
        ...
        try:
            with urllib.request.urlopen(req, timeout=5) as resp:
                ...
                config = json.loads(txt) if txt else {}
        except Exception:
            # Nếu mất mạng hoặc lỗi server, cho phép app tiếp tục để dùng offline
            pass

        min_ver = config.get("minAppVersion", "2.6.0")
        latest_ver = config.get("latestVersion", "2.6.0")
        update_url = config.get("updateUrl", "https://drive.google.com")
        ...
        if parse_version(APP_VERSION) < parse_version(min_ver):
            ...
            dlg = ft.AlertDialog(
                modal=True,
                title=ft.Row([
                    ft.Icon(ft.Icons.WARNING_ROUNDED, color=ft.Colors.AMBER, size=30),
                    ft.Text("YÊU CẦU CẬP NHẬT", weight=ft.FontWeight.BOLD, size=16)
                ], alignment=ft.MainAxisAlignment.START),
                content=ft.Column([
                    ft.Text(f"Phiên bản ứng dụng của bạn ({APP_VERSION}) đã quá cũ.", size=14),
                    ft.Text(f"Vui lòng nâng cấp lên phiên bản mới nhất ({latest_ver}) để tiếp tục sử dụng ổn định.", size=14),
                    ft.Container(height=10),
                    ft.Text("Lưu ý: Hệ thống đã chặn đăng nhập đối với phiên bản cũ này.", color=ft.Colors.RED_400, size=12, italic=True)
                ], tight=True, spacing=6),
                actions=[
                    ft.TextButton(
                        content=ft.Row([
                            ft.Icon(ft.Icons.DOWNLOAD_ROUNDED),
                            ft.Text("Tải Bản Mới Ngay", weight=ft.FontWeight.BOLD)
                        ], tight=True),
                        on_click=open_url,
                        style=ft.ButtonStyle(color=ft.Colors.WHITE, bgcolor=GREEN_MID)
                    )
                ],
                actions_alignment=ft.MainAxisAlignment.CENTER,
            )
            _show_dialog(page, dlg)
            return  # DỪNG Ở ĐÂY — KHÔNG CHO AUTO LOGIN HAY VÀO LOGIN VIEW
    except Exception as _e:
        print(f"Force update check err: {_e}")
